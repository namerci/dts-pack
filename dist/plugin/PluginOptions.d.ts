...
export declare type OptionsWithAllOptionals = {
    [P in keyof Options]?: Options[P] | undefined;
};
export declare type OptionsRequiredForPluginOptions = {};
export declare type OptionsBase = OptionsWithAllOptionals & OptionsRequiredForPluginOptions;
