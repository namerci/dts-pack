 ...
 */
function pickupRootPath(path1, path2) {
    var prefix = '';
    ...
    var path1Tokens = path1.split(path.sep);
    var path2Tokens = path2.split(path.sep);
    var count = path1Tokens.length;
...
exports.default = pickupRootPath;
